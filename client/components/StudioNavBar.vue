    ...
    <v-app-bar class="white" app clipped-left>
      ...
      <v-menu offset-y left>
        ...
        <v-card>
          ...
          <v-list>
            <v-list-item router :to="`/Channels/${this.$auth.user._id}`">
              <v-list-item-icon>
          ...
          <v-list class="text-center">
            <v-list-item class="px-2">
              <v-btn
                ...
                depressed
                fab
                :to="`/Channels/${$auth.user._id}`"
                class="white--text mx-auto"
              >
                <h1 class="display-1">YT</h1>
              </v-btn>
            </v-list-item>

            <v-list-item link :to="`/Channels/${$auth.user._id}`">
              <v-list-item-content>
...
export default {
  ...
  mounted() {
    ...
    this.username = this.$auth ? this.$auth.user.name : "X";
