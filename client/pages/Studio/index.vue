<template>
  <div id="dashboard" class="pa-4">
    <v-container fluid>
      <v-btn text small class="pl-0" @click="$router.push('/')">
        <v-icon left>mdi-arrow-left</v-icon> YouTube</v-btn
      >
        ...
        <v-col cols="12" sm="6" md="4">
          <v-card class="mx-auto" outlined>
            ...
            <v-card-actions class="d-block ml-2">
              <v-btn color="blue" text> Go to video analytics </v-btn>
              <br />
              <v-btn color="blue" text> See comments (4) </v-btn>
            </v-card-actions>
          </v-card>
        </v-col>
        <v-col cols="12" sm="6" md="4">
          <v-card class="mx-auto" outlined>
            ...
            <v-card-actions class="d-block ml-2">
              <v-btn color="blue" text> Check it out </v-btn>
            </v-card-actions>
          </v-card>
        </v-col>
        <v-col cols="12" sm="6" md="4">
          <v-card class="mx-auto" outlined>
            ...
            <v-card-actions class="d-block ml-2">
              <v-btn color="blue" text> Go to channel analytics </v-btn>
            </v-card-actions>
          </v-card>
        </v-col>
        <v-col cols="12" sm="6" md="4">
